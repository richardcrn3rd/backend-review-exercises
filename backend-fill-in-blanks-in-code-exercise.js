...
req.currentUser = await User.findByPk(payload.id);
...
const place = await Place.findByPk(placeId, { include: [Comment] });
...
res.cookie('csrfToken', generateToken(), { httpOnly: true, secure: true });
